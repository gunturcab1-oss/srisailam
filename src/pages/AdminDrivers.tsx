          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-gray-300">
                Admin creates driver login access. Drivers do not self-register and only see bookings assigned by admin.
              </p>
            </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-lg md:p-8">
            <div className="mb-6 flex items-end justify-between gap-4">
              ...
              <div className="rounded-full bg-gray-100 px-4 py-2 text-sm font-bold text-gray-600">{drivers.length} drivers</div>
            </div>
