...
export const FLEET_DATA: Car[] = [
  ...
  },
  {
    ...
    type: 'SUV',
    capacity: '6+1 Seater',
    image: '/images/Toyota-Innova-Crysta-GX-Variant-Front-Three-Quarters.jpeg',
  ...
  },
  {
    ...
    image: '/images/6660d8670e4025c6bac778f78848fa2d.jpg',
...
export const TOURIST_PLACES: Place[] = [
  {
    ...
    image: '/images/srisaila-mallikarjuna-swamy-temple-mallikarjun-jyotirlinga-srisailam-tourism-entry-fee-timings-holidays-reviews-header.jpg'
  },
  {
    id: 'bhramaramba',
    name: 'Bhramaramba Devi Temple',
    description: 'One of the eighteen Shakti Peethas, located within the main temple complex.',
    image: '/images/temple_rEEq67u4_202408201723250.jpg'
  },
  {
    id: 'dam',
    name: 'Srisailam Dam',
